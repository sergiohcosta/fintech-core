...
- **Root directory**: /home/sergio/fintech-core
- **Server command**:
```bash
npx @modelcontextprotocol/server-filesystem --path "/home/sergio/fintech-core"
```

## 2. GitHub MCP (optional)
- **Purpose**: Efficient issue management, pull request creation, and repository analysis
- **Repository**: https://github.com/sergiohcosta/fintech-core.git
...
```
claude mcp add github --transport http "https://github.com/sergiohcosta/fintech-core.git"
```
...
- **Server command**:
```bash
npx @modelcontextprotocol/server-git --path "/home/sergio/fintech-core"
```

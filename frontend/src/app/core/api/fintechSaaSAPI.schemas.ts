...
export interface BudgetCycleOpenRequest {
  ...
  /**
     * Dia do mês em que o ciclo começa (1 = mês calendário)
     * @minimum 1
     * @maximum 28
     */
  startDay: number;
...
export interface BudgetCycleResponse {
  id?: string;
  /** Mês de referência do ciclo (yyyy-MM) */
  referenceMonth?: string;
  startDate?: string;
  endDate?: string;
  openingBalance?: number;
...
export interface BudgetItemRealizeRequest {
  /**
     * ID da transação existente. Se null, cria uma nova transação.
     * @nullable
     */
  transactionId?: string | null;
}

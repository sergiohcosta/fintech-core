...
export class DashboardService {
 ...
 getDashboardSummary<TData = DashboardSummaryDTO>(params: GetDashboardSummaryParams, options?: HttpClientBodyOptions): Observable<TData>;
 getDashboardSummary<TData = DashboardSummaryDTO>(params: GetDashboardSummaryParams, options?: HttpClientEventOptions): Observable<HttpEvent<TData>>;
 getDashboardSummary<TData = DashboardSummaryDTO>(params: GetDashboardSummaryParams, options?: HttpClientResponseOptions): Observable<AngularHttpResponse<TData>>;
  getDashboardSummary<TData = DashboardSummaryDTO>(
    params: GetDashboardSummaryParams, options?: HttpClientObserveOptions): Observable<TData | HttpEvent<TData> | AngularHttpResponse<TData>> {

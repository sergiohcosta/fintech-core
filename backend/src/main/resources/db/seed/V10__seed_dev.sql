...
INSERT INTO categories (id, tenant_id, created_by, name, icon, color, taxonomy_code) VALUES
  ...
  (c_roupas,      v_tenant, v_carlos, 'Roupas & Casa', 'checkroom',     '#8D6E63', 'CLOTHING'),
  (c_receitas,    v_tenant, v_carlos, 'Receitas',      'attach_money',  '#26A69A', 'INCOME'),
  (c_assinaturas, v_tenant, v_carlos, 'Assinaturas',   'smartphone',    '#BDBDBD', 'SUBSCRIPTIONS');
...
-- Filhas — Roupas & Casa
INSERT INTO categories (id, tenant_id, created_by, name, icon, color, parent_id, taxonomy_code) VALUES
  (c_compras_gerais, v_tenant, v_carlos, 'Compras Gerais', 'shopping_bag', '#8D6E63', c_roupas, 'CLOTHING_APPAREL');
...
INSERT INTO categories (id, tenant_id, created_by, name, icon, color, parent_id, taxonomy_code) VALUES
  ...
  (c_rendimentos, v_tenant, v_carlos, 'Rendimentos', 'account_balance','#26A69A', c_receitas, 'INCOME_INVESTMENT_RETURNS');

-- Filhas — Assinaturas
INSERT INTO categories (id, tenant_id, created_by, name, icon, color, parent_id, taxonomy_code) VALUES
  (c_servicos_dig, v_tenant, v_carlos, 'Serviços Digitais', 'cloud', '#BDBDBD', c_assinaturas, 'SUBSCRIPTIONS_SOFTWARE');
